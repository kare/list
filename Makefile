...
vet: test
	gofmt -s -w $(GENERATED_FILES) list.go
	golint $(GENERATED_FILES) list.go
	govet $(GENERATED_FILES) list.go
	errcheck $(GENERATED_FILES) list.go
	staticcheck $(GENERATED_FILES) list.go
	unused $(GENERATED_FILES) list.go
	gosimple $(GENERATED_FILES) list.go
